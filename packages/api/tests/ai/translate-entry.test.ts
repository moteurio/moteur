...
/**
 * Plugin AI route: /ai/translate/entry. Currently stubbed (501) in plugin; translation logic tested in translation.test.ts.
 */
...
describe('POST /ai/translate/entry (plugin stub)', () => {
